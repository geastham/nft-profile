...
async function main() {
	...
	const tableland = await connect({ signer, chain: "ethereum-goerli" })
	...
	const nftProfile = await NFTProfile.deploy(tablelandBaseURI, mainName, attributesName)
	...
	await nftProfile.deployTransaction.wait(5)
	...
	const mintToken = await nftProfile.mint()
